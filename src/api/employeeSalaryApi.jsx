...
export const postEmployeeSalary = async (salaryData) => {
    try {
        const response = await apiClient.post(`/admin/employee-salary-management/save`, salaryData);
...
export const fetchAllEmployeeSalaries = async () => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/all`); 
        return response.data;
    } catch (error) {
...
export const fetchEmployeeSalariesByEmployeeId = async (employeeId) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/employee/${employeeId}`); 
        return response.data;
    } catch (error) {
...
export const fetchEmployeeSalaryById = async (id) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/id/${id}`); 
        return response.data;
    } catch (error) {
...
export const updateEmployeeSalary = async (id, updatedData) => {
    try {
        const response = await apiClient.put(`/admin/employee-salary-management/update/${id}`, updatedData);
        return response.data;
    } catch (error) {
...
export const deleteEmployeeSalary = async (id) => {
    try {
        const response = await apiClient.delete(`/admin/employee-salary-management/delete/${id}`); 
        return response.data;
    } catch (error) {
...
export const filterEmployeeSalaries = async (employeeId, year, month) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/filter`, {
...
export const fetchPaginatedSalaries = async (employeeId, page, size) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/pagination`, {
...
export const fetchEmployeeSalarySummary = async (employeeId) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/summary`, {
            params: { employeeId }
        });
        return response.data;
    } catch (error) {
...
export const fetchEmployeeSalaryDashboard = async (employeeId, page, size) => {
    try {
        const response = await apiClient.get(`/admin/employee-salary-management/dashboard`, {
            params: { employeeId, page, size }
        });
        return response.data;
    } catch (error) {
