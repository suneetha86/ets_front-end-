            ...
            <div className='flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-xl shadow-sm border border-slate-100'>
                <div className='flex items-center gap-4'>
                    ...
                    <div>
                        ...
                        <p className='text-slate-500 text-sm'>Stay updated with your daily operational alerts.</p>
                    </div>
                </div>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='mt-10 pt-6 border-t border-slate-100 flex justify-end gap-3'>
                                <button
                                    ...
                                    className='px-6 py-2.5 rounded-xl text-[10px] font-black text-red-600 border border-red-100 hover:bg-red-50 transition-all uppercase tracking-widest flex items-center gap-2'
                                >
                                    <Trash2 size={14} /> Delete Permanent
                                </button>
                                <button
                                    onClick={() => setIsModalOpen(false)}
                                    className='px-8 py-2.5 rounded-xl text-[10px] font-black text-white bg-slate-800 hover:bg-slate-900 shadow-lg shadow-slate-900/20 transition-all uppercase tracking-widest border border-transparent'
                                >
                                    Close Terminal
                                </button>
                            </div>
